    ...
    "properties": {
        ...
        "title": {
            ...
            "description": (
                ...
                "lowercased, built ONLY from the motion's own nouns and verbs "
                "with no paraphrasing: 'This House Would ban zoos' becomes 'Ban "
                "Zoos'. POSITION is OG, OO, CG or CO. "
                "Examples: 'THW Ban Zoos (OG)', 'THBT Social Media Has Harmed "
                "Democracy (CO)'. "
                "The title names the debate topic and nothing else. It must "
                "NEVER contain words describing the work or the current stage — "
                "no 'seed', 'seeds', 'bench', 'shortlist', 'pool', 'scoring', "
                "'ranking', 'ideas', 'case', 'draft'. The title is fixed for the "
                "life of the motion, so a word that only makes sense in Stage 1 "
